...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 21 09:54:02 2019
...
urlpatterns = [
    ...
    path(r'login/', views.user_login, name='user_login'),  # 使用Django内置的登录方法
    ...
    path('my-home-page/', views.my_home_page, name='my_home_page'),
